<!DOCTYPE html><html lang="en" class="js-focus-visible js" data-js-focus-visible=""><head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai.pydantic.dev/api/models/wrapper/">
      
      
        <link rel="prev" href="../fallback/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.6.5">
        ...
        <title>pydantic_ai.models.wrapper - PydanticAI</title>
    ...
    <script>__md_scope=new URL("../../..",location),__md_hash=e=>[...e].reduce(((e,_)=>(e<<5)-e+_.charCodeAt(0)),0),__md_get=(e,_=localStorage,t=__md_scope)=>JSON.parse(_.getItem(t.pathname+"."+e)),__md_set=(e,_,t=localStorage,a=__md_scope)=>{try{t.setItem(a.pathname+"."+e,JSON.stringify(_))}catch(e){}}</script>
        ...
        <meta property="og:title" content="pydantic_ai.models.wrapper - PydanticAI">
      
        <meta property="og:description" content="Agent Framework / shim to use Pydantic with LLMs">
      
        <meta property="og:image" content="https://ai.pydantic.dev/assets/images/social/api/models/wrapper.png">
        ...
        <meta property="og:url" content="https://ai.pydantic.dev/api/models/wrapper/">
      
        <meta name="twitter:card" content="summary_large_image">
      
        <meta name="twitter:title" content="pydantic_ai.models.wrapper - PydanticAI">
      
        <meta name="twitter:description" content="Agent Framework / shim to use Pydantic with LLMs">
      
        <meta name="twitter:image" content="https://ai.pydantic.dev/assets/images/social/api/models/wrapper.png">
   ...
   <link href="../../../assets/stylesheets/glightbox.min.css" rel="stylesheet"><style>
    ...
    <div data-md-component="skip">
        ...
        <a href="#pydantic_aimodelswrapper" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc">
        ...
        <li class="md-nav__item">
  <a href="#pydantic_ai.models.wrapper" class="md-nav__link">
    <span class="md-ellipsis">
      wrapper
    </span>
  </a>
        ...
        <li class="md-nav__item">
  <a href="#pydantic_ai.models.wrapper.WrapperModel" class="md-nav__link">
    <span class="md-ellipsis">
      WrapperModel
    </span>
  </a>
  
    <nav class="md-nav" aria-label="WrapperModel">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#pydantic_ai.models.wrapper.WrapperModel.wrapped" class="md-nav__link">
    <span class="md-ellipsis">
      wrapped
    </span>
  </a>
  ...
  <span class="md-ellipsis">
    pydantic_evals.generation
              ...
              <div class="md-sidebar md-sidebar--secondary" data-md-component="sidebar" data-md-type="toc" style="top: 48px;">
                <div class="md-sidebar__scrollwrap" style="height: 434px;">
                  <div class="md-sidebar__inner">
...
<h1 id="pydantic_aimodelswrapper">pydantic_ai.models.wrapper</h1>
...
<a id="pydantic_ai.models.wrapper"></a>
...
<h3 id="pydantic_ai.models.wrapper.WrapperModel" class="doc doc-heading">
            <span class="doc doc-object-name doc-class-name">WrapperModel</span>
  ...
  <span class="doc doc-labels">
    ...
    <div class="doc doc-contents ">
        ...
        <p>Model which wraps another model.</p>
<p>Does nothing on its own, used as a base class.</p>
              ...
              <details class="quote">
                <summary>Source code in <code>pydantic_ai_slim/pydantic_ai/models/wrapper.py</code></summary>
...
<span class="normal">49</span></pre></div></td><td class="code"><div><pre id="__code_0"><span></span><button class="md-clipboard md-icon" title="Copy to clipboard" data-clipboard-target="#__code_0 > code"></button><code tabindex="0"><span class="nd">@dataclass</span><span class="p">(</span><span class="n">init</span><span class="o">=</span><span class="kc">False</span><span class="p">)</span>
<span class="k">class</span><span class="w"> </span><span class="nc">WrapperModel</span><span class="p">(</span><span class="n">Model</span><span class="p">):</span>
<span class="w">    </span><span class="sd">"""Model which wraps another model.</span>

<span class="sd">    Does nothing on its own, used as a base class.</span>
<span class="sd">    """</span>

    <span class="n">wrapped</span><span class="p">:</span> <span class="n">Model</span>
<span class="w">    </span><span class="sd">"""The underlying model being wrapped."""</span>

    <span class="k">def</span><span class="w"> </span><span class="fm">__init__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">wrapped</span><span class="p">:</span> <span class="n">Model</span> <span class="o">|</span> <span class="n">KnownModelName</span><span class="p">):</span>
        <span class="bp">self</span><span class="o">.</span><span class="n">wrapped</span> <span class="o">=</span> <span class="n">infer_model</span><span class="p">(</span><span class="n">wrapped</span><span class="p">)</span>

    <span class="k">async</span> <span class="k">def</span><span class="w"> </span><span class="nf">request</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="o">*</span><span class="n">args</span><span class="p">:</span> <span class="n">Any</span><span class="p">,</span> <span class="o">**</span><span class="n">kwargs</span><span class="p">:</span> <span class="n">Any</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">tuple</span><span class="p">[</span><span class="n">ModelResponse</span><span class="p">,</span> <span class="n">Usage</span><span class="p">]:</span>
        <span class="k">return</span> <span class="k">await</span> <span class="bp">self</span><span class="o">.</span><span class="n">wrapped</span><span class="o">.</span><span class="n">request</span><span class="p">(</span><span class="o">*</span><span class="n">args</span><span class="p">,</span> <span class="o">**</span><span class="n">kwargs</span><span class="p">)</span>
    ...
    <span class="p">)</span> <span class="o">-&gt;</span> <span class="n">AsyncIterator</span><span class="p">[</span><span class="n">StreamedResponse</span><span class="p">]:</span>
        <span class="k">async</span> <span class="k">with</span> <span class="bp">self</span><span class="o">.</span><span class="n">wrapped</span><span class="o">.</span><span class="n">request_stream</span><span class="p">(</span><span class="n">messages</span><span class="p">,</span> <span class="n">model_settings</span><span class="p">,</span> <span class="n">model_request_parameters</span><span class="p">)</span> <span class="k">as</span> <span class="n">response_stream</span><span class="p">:</span>
    ...
    <span class="k">def</span><span class="w"> </span><span class="nf">model_name</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">wrapped</span><span class="o">.</span><span class="n">model_name</span>
    ...
    <span class="k">def</span><span class="w"> </span><span class="nf">system</span><span class="p">(</span><span class="bp">self</span><span class="p">)</span> <span class="o">-&gt;</span> <span class="nb">str</span><span class="p">:</span>
        <span class="k">return</span> <span class="bp">self</span><span class="o">.</span><span class="n">wrapped</span><span class="o">.</span><span class="n">system</span>
    ...
    <span class="k">def</span><span class="w"> </span><span class="fm">__getattr__</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">item</span><span class="p">:</span> <span class="nb">str</span><span class="p">):</span>
        <span class="k">return</span> <span class="nb">getattr</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">wrapped</span><span class="p">,</span> <span class="n">item</span><span class="p">)</span>
...
<h4 id="pydantic_ai.models.wrapper.WrapperModel.wrapped" class="doc doc-heading">
            <span class="doc doc-object-name doc-attribute-name">wrapped</span>
...
<div class="language-python doc-signature highlight"><pre id="__code_1"><span></span><button class="md-clipboard md-icon" title="Copy to clipboard" data-clipboard-target="#__code_1 > code"></button><code><span class="n">wrapped</span><span class="p">:</span> <span class="n"><a class="autorefs autorefs-internal" title="pydantic_ai.models.Model" href="../base/#pydantic_ai.models.Model">Model</a></span> <span class="o">=</span> <span class="n"><span title="pydantic_ai.models.infer_model">infer_model</span></span><span class="p">(</span><span class="n"><span title="pydantic_ai.models.wrapper.WrapperModel(wrapped)">wrapped</span></span><span class="p">)</span>
</code></pre></div>

    <div class="doc doc-contents ">

        <p>The underlying model being wrapped.</p>
    </div>
