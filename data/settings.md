...
<span class="sd">    You should either alter `temperature` or `top_p`, but not both.</span>
...
<span class="sd">    """</span>
    ...
    <span class="n">frequency_penalty</span><span class="p">:</span> <span class="nb">float</span>
